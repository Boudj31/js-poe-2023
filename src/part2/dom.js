...
vP.textContent = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, voluptatibus."
...
vButton.setAttribute("class","bg-purple-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded")
vButtonEnfant.setAttribute("class","bg-purple-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded")

vDivC.setAttribute("class","block whitespace-pre bg-gray-100 shadow-lg my-2 italic text-lg")
/*
1. Créer un élément h1 avec le texte "Hello World"
2. Ajouter le à la balise body
*/
...
text1.textContent = "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, voluptatibus."
...
const pCreate = () => {
    ...
    const pTextNode = document.createTextNode("Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam, voluptatibus.");//  Ajouter le texte
